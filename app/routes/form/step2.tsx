...
export default function Step2() {
  ...
  const renderSegment = () => {
    switch (activeSegment) {
      ...
      case "government":
        return (
          <GovernmentSegment onNext={handleNext} onPrevious={handlePrevious} />
        );
      case "b2c":
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="border-r border-gray-300 pt-10">
          <div className="w-[90%] mx-auto">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-lg flex items-center ${
                      activeSegment === segment ? "bg-gray-50" : ""
                    }`}
                  ...
                  >
                    <div className="mr-3">
                      {isCompleted ? (
                        <svg
                          className="w-5 h-5 text-white bg-black rounded-full"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
            ...
            <div className="text-center">
              <Button variant="default" className="text-sm uppercase mt-24">
                Save & Continue Later
              </Button>
            </div>
          </div>
        ...
        <div className="col-span-2 pb-10">{renderSegment()}</div>
